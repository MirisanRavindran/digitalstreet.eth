...
export type OnClientEvent = <Payload>(collection: string, eventType: EventType, event: BaseStreamMessage<Payload>) => boolean;
/**
...
export type ItemTransferredEvent = BaseStreamMessage<ItemTransferredEventPayload>;
...
export type ItemReceivedBidEvent = BaseStreamMessage<ItemReceivedBidEventPayload>;
...
export type ItemReceivedOfferEvent = BaseStreamMessage<ItemReceivedOfferEventPayload>;
...
export type CollectionOfferEvent = BaseStreamMessage<CollectionOfferEventPayload>;
