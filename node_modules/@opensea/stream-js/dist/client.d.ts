import { ClientConfig, BaseStreamMessage, EventType, ItemMetadataUpdate, ItemListedEvent, ItemSoldEvent, ItemTransferredEvent, ItemReceivedBidEvent, ItemReceivedOfferEvent, ItemCancelledEvent, CollectionOfferEvent, TraitOfferEvent, Callback } from './types';
export declare class OpenSeaStreamClient {
    private socket;
    private channels;
    private logLevel;
    private onEvent;
    constructor({ network, token, apiUrl, connectOptions, logLevel, onError, onEvent }: ClientConfig);
    private debug;
    private info;
    private warn;
    private error;
    ...
    onCollectionOffer: (collectionSlug: string, callback: Callback<CollectionOfferEvent>) => () => void;
    onTraitOffer: (collectionSlug: string, callback: Callback<TraitOfferEvent>) => () => void;
